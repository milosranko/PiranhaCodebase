...
public class CarouselItemBlock : BlockBase
{
    ...
    [StringLength(50, ErrorMessage = $"{nameof(Title)}: maximum length is 50 characters!")]
    ...
    [StringLength(150, ErrorMessage = "Image Alternate Text: maximum length is 150 characters!")]
