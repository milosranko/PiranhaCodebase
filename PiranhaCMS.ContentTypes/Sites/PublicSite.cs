...
public class GlobalSettings
{
    ...
    [Field(
        Title = "Music Search Page Reference",
        Options = FieldOption.HalfWidth,
        Description = "Reference to Music search page")]
    public PageField MusicSearchPageReference { get; set; }

    [Field(
        Title = "Music Search Page Size",
        Options = FieldOption.HalfWidth,
        Description = "Number of Music search results per page")]
    public NumberField MusicPageSize { get; set; }
}
